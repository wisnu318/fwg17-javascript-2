...
// function searchName (valueSearch, jumlahIndex, callback) {





function callback(searchEnggine){
    console.log(searchEnggine)
}


// searchName("an", 3, callback)

function sayHello(name, showGreeting){
    let guy = `Hello ${name}` ;
    showGreeting(guy);
}
...
sayHello('faztrack', showGreeting)